# CLAUDE.md — Mid-Course Capstone (HO7)
...
## About this project
A mid-course capstone combining prompts, context and automation.
**Primary way to do it:** Claude.ai / Claude Cowork (build it no-code) — **no API key needed.**
...
- It's the **Mid-Course Capstone** hands-on. No-code build; any Python automation is optional/advanced.
